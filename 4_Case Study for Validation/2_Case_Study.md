...
$$
LCA_{i,production} = \sum_{j} LCI_{i,j,production} * Flows_j
$$

$$
LCA_{i,use-phase} = \sum_{k_{all}} LCA_{i,k,use-phase} + \sum_{j} LCA_{i,j,use-phase}
$$

$$
LCA_{i,End-of-Life(EoL)-phase} = \sum_{k_{all}} LCA_{i,k,EoL-phase} + \sum_{j} LCA_{i,j,EoL-phase}
$$
